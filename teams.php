...
<body>
	...
	<div class="section sectionGray sectionPadding">
		<div class="sectionInner">
			<div class="sectionTitle tahoma">SELECT YOUR TEAM</div>
			<div class="sectionSubtitle">Choose A Team To Check Ticket Availability</div>
			
			<div class="teamsContainer">
				<div class="teamTab">The Team Name</div>
				<div class="teamTab">The Team Name</div>
				<div class="teamTab">The Team Name</div>
				<div class="teamTab">The Team Name</div>
				<div class="teamTab">The Team Name</div>
