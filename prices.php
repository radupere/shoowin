...
<body>
	...
	<div class="section sectionGray sectionPadding">
		<div class="sectionInner">
			<div class="sectionTitle tahoma">COMPARE PRICES</div>
			<div class="sectionSubtitle">Compare prices with our competitors and choose the game</div>
			
			<div class="pricesContainer">
				
				<div class="pricesTab">
					<div class="pricesTabTeamName">The Team Name</div>
					<div class="pricesTabPricesContainer">
						<div class="pricesTabContainerHalf pricesTabContainerHalf_1">
							<div class="priceTabTitle">Their Price:</div>
							<div class="priceTabTheir">$150.15</div>
						</div>
						<div class="pricesTabContainerHalf">
							<div class="priceTabTitle">Our Price:</div>
							<div><span class="priceTabOur">$30.15</span> <span class="priceTabOurSmall"> (reservation)</span></div>
							<div><span class="priceTabOur">$100.57</span> <span class="priceTabOurSmall"> (full ticket)</span></div>
						</div>
					</div>
					<div class="pricesTabButtonContainer">
						<div class="button buttonPricesSelectSeats">SELECT SEATS</div>
					</div>
				</div>
