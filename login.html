...
<div class="section sectionGray sectionPadding">
    <div class="sectionInner">
        ...
        <div class="loginRegisterContainer">
            <div class="loginTabButton loginTabActive" id="loginTabButton_login">Login</div>
            <div class="loginTabButton" id="loginTabButton_register">Register</div>
            ...
            <div class="loginRegisterTab loginRegisterTabActive" id="loginTab">
                ...
                <div class="button buttonLoginRegister">Login</div>
            </div>
            ...
            <div class="loginRegisterTab" id="registerTab">
                ...
                <div class="button buttonLoginRegister">Register</div>
            </div>
