...
<body>
	...
	<div class="section sectionGray sectionPadding">
		<div class="sectionInner">
			<div class="sectionTitle tahoma">CHECKOUT</div>
			<div class="sectionSubtitle">Enter Your Payment Information</div>
			
			<div class="checkoutContainer">
				<div class="checkoutInfo">
					<input type="text" class="checkutInput checkoutInputHalf" placeholder="First Name"/>
					<input type="text" class="checkutInput checkoutInputHalf" placeholder="Last Name"/>
					
					<input type="text" class="checkutInput checkoutInputFull" placeholder="Address"/>
					
					<input type="email" class="checkutInput checkoutInputHalf" placeholder="Email"/>
					<input type="tel" class="checkutInput checkoutInputHalf" placeholder="Phone"/>
					
					<img src="img/creditcards.png" class="creditCardsIcons"/>
					
					<input type="text" class="checkutInput checkoutInputFull" placeholder="Card Number"/>
					
					<input type="text" class="checkutInput checkoutInputFull" placeholder="Cardholder Name"/>
					
					<input type="text" class="checkutInput checkoutInputHalf" placeholder="Expiration Month"/>
					<input type="text" class="checkutInput checkoutInputHalf" placeholder="Expiration Year"/>
					
					<input type="text" class="checkutInput checkoutInputHalf" placeholder="CVV"/>
					<div class="button buttonPay">Pay</div>
				</div>
				
				<div class="checkoutSummary">
					<div class="checkoutSummaryTitle">Summary</div>
					<div class="checkoutSummaryText">Superbowl</div>
					<div class="checkoutSummaryText">The Team Name</div>
					<div class="checkoutSummaryText">2 tickets</div>
					<div class="checkoutSummaryText">Upper level</div>
					<div class="checkoutSummaryTotal">
						<span class="checkoutSummaryTotalText">TOTAL:</span>
						<span class="checkoutSummaryTotalPrice">$123.45</span>
					</div>
				</div>
			</div>
		</div>
