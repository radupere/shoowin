...
<body>
	...
	<div class="section sectionGray sectionPadding">
		<div class="sectionInner">
			<div class="sectionTitle tahoma">SELECT YOUR SEATS</div>
			<div class="sectionSubtitle">Choose Your Seats And Number Of Tickets</div>
			
			<div class="seatsContainer">
				<div class="seatsStadiumContainer">
					<img src="img/stadium.png"/>
				</div>
				<div class="seatsInfoContainer">
					<select class="zoneSelect">
						<option selected="selected" disabled="disabled">Seating zone</option>
						<option>1</option>
						<option>2</option>
					</select class="seatsSelect">
					<select class="seatsSelect">
						<option selected="selected" disabled="disabled">Number of seats</option>
						<option>1</option>
						<option>2</option>
					</select>
					<div class="seatsText">
						<span>Reservation Cost:</span>
						<span class="seatsPrice">$20.12</span>
					</div>
					<div class="seatsText">
					...
					<div class="seatsText">
						<span class="seatsTextSmall">(paid later if your team makes it)</span>
					</div>
					<div class="button buttonAddToCart">ADD TO CART</div>
				</div>
			</div>
		</div>
	</div>
